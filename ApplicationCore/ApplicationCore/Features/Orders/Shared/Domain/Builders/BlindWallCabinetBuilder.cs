...
internal class BlindWallCabinetBuilder : CabinetBuilder<BlindWallCabinet> {
    ...
    public override BlindWallCabinet Build() {
        var cabinet = BlindWallCabinet.Create(Qty, UnitPrice, ProductNumber, Room, Assembled, Height, Width, Depth, BoxMaterial, FinishMaterial, MDFDoorOptions, EdgeBandingColor, RightSide, LeftSide, Comment, Doors, BlindSide, BlindWidth, AdjustableShelves, ExtendDown);
        return cabinet;
    }
