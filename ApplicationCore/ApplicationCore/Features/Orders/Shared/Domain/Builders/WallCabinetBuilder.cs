...
internal class WallCabinetBuilder : CabinetBuilder<WallCabinet> {
    ...
    public override WallCabinet Build() {
        return WallCabinet.Create(Qty, UnitPrice, Room, Assembled, Height, Width, Depth, BoxMaterial, FinishMaterial, EdgeBandingColor, RightSide, LeftSide, Doors, Inside, FinishBottom);
    }
