...
internal class BaseCabinetBuilder : CabinetBuilder<BaseCabinet> {
    ...
    public override BaseCabinet Build() {
        var cabinet = BaseCabinet.Create(Qty, UnitPrice, ProductNumber, Room, Assembled, Height, Width, Depth, BoxMaterial, FinishMaterial, EdgeBandingColor, RightSide, LeftSide, Doors, ToeType, Drawers, Inside);
        return cabinet;
    }
