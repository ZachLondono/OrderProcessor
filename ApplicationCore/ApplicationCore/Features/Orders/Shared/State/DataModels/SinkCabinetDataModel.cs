...
internal class SinkCabinetDataModel : CabinetRollOutContainerDataModelBase, IProductDataModel, IQueryableProductDataModel {
    ...
    public IProduct MapToProduct() {
        ...
        return new SinkCabinet(Id, Qty, UnitPrice, ProductNumber, Room, Assembled, Height, Width, Depth, boxMaterial, finishMaterial, mdfConfig, EdgeBandColor, RightSideType, LeftSideType, Comment,
    ...
    public static string GetQueryByOrderId
        ...
        FROM sink_cabinets
            ...
            JOIN roll_out_configs ON roll_out_configs.id = sink_cabinets.roll_out_config_id
