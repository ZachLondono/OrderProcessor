...
public class ShoeShelf : IAllmoxyProduct {

    [Index(0)] public required string Folder { get; set; }
    [Index(1)] public string Name => "Elite Tag Shoe Shelves";
    ...
    [Index(7)] public required string PanelDepth { get; set; }
    [Index(8)] public required string PartComment { get; set; }
