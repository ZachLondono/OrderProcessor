...
public class FixedLShapedShelf : IAllmoxyProduct {
    ...
    [Index(7)] public required bool DoubleCams { get; set; }
    [Index(8)] public required bool InstallCams { get; set; }
    [Index(9)] public required int Qty { get; set; }
    [Index(10)] public required double A { get; set; }
    [Index(11)] public required double B { get; set; }
    [Index(12)] public required double C { get; set; }
    [Index(13)] public required double D { get; set; }
    [Index(14)] public required string NotchSide { get; set; }
    [Index(15)] public required string PartComment { get; set; }
