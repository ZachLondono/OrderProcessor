...
public class AdjustableShelf : IAllmoxyProduct {

    [Index(0)] public required string Folder { get; set; }
    [Index(1)] public string Name => "Adjustable Shelves";
    ...
    [Index(10)] public required bool AddLEDChannel { get; set; }
    [Index(11)] public required double LEDOffFront { get; set; }
    [Index(12)] public required double LEDWidth { get; set; }
    [Index(13)] public required double LEDDepth { get; set; }
