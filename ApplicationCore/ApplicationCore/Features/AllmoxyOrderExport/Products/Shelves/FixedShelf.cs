...
public class FixedShelf : IAllmoxyProduct {
    ...
    [Index(7)] public required bool InstallCams { get; set; }
    [Index(8)] public required int Qty { get; set; }
    [Index(9)] public required double Width { get; set; }
    [Index(10)] public required double Depth { get; set; }
    [Index(11)] public required string Recess { get; set; }
    [Index(12)] public required bool DrawerLock { get; set; }
