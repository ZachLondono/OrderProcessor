...
public class FixedAngledShelf : IAllmoxyProduct {

    [Index(0)] public required string Folder { get; set; }
    [Index(1)] public string Name => "Fixed Angled Shelves";
    ...
    [Index(7)] public required double A { get; set; }
    [Index(8)] public required double B { get; set; }
    [Index(9)] public required double C { get; set; }
    [Index(10)] public required double D { get; set; }
    [Index(11)] public required string NotchSide { get; set; }
    [Index(12)] public required string Recess { get; set; }
