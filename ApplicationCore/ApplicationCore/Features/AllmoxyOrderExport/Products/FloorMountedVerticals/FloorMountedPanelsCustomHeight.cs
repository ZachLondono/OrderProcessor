...
public class FloorMountedPanelsCustomHeight : IAllmoxyProduct {

    [Index(0)] public required string Folder { get; set; }
    [Index(1)] public string Name => "Floor Mounted Panels - Custom Height";
    ...
    [Index(10)] public required double Height { get; set; }
