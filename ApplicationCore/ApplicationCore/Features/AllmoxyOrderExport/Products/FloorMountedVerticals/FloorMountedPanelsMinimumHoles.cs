...
public class FloorMountedPanelsMinimumHoles : IAllmoxyProduct {

    [Index(0)] public required string Folder { get; set; }
    [Index(1)] public string Name => "Floor Mounted Panels - Minimum Holes";
    ...
    [Index(9)] public required string IncludedHoles { get; set; }
    [Index(10)] public required int Qty { get; set; }
    [Index(11)] public required string PanelHeight { get; set; }
    [Index(12)] public required double Depth { get; set; }
    [Index(13)] public required string FinishedSide { get; set; }
    [Index(14)] public required string PartComment { get; set; }
