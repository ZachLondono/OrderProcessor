...
public class WallMountedHutchPanels : IAllmoxyProduct {

    [Index(0)] public required string Folder { get; set; }
    [Index(1)] public string Name => "Wall Mounted Hutch Panels";
    [Index(2)] public required string ClosetMaterial { get; set; }
    [Index(3)] public required string BandingColor { get; set; }
    [Index(4)] public required bool RadiusedBottom { get; set; }
    [Index(5)] public required bool EdgeBandTop { get; set; }
    ...
    [Index(10)] public required string DrawerPanelHeight { get; set; }
    [Index(11)] public required string FinishedSide { get; set; }
    [Index(12)] public required double Depth { get; set; }
    [Index(13)] public required double TopDepth { get; set; }
