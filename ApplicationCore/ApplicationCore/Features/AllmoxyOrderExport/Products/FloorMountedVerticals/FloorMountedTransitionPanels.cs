...
public class FloorMountedTransitionPanels : IAllmoxyProduct {

    [Index(0)] public required string Folder { get; set; }
    [Index(1)] public string Name => "Floor Mounted Transition Panels";
    ...
    [Index(12)] public required double TransitionDepth { get; set; }
