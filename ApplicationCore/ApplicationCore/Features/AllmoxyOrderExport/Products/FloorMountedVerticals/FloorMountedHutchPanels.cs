...
public class FloorMountedHutchPanels : IAllmoxyProduct {

    [Index(0)] public required string Folder { get; set; }
    [Index(1)] public string Name => "Floor Mounted Hutch Panels";
    ...
    [Index(11)] public required string DrawerPanelHeight { get; set; }
    [Index(12)] public required double Depth { get; set; }
    [Index(13)] public required double TopDepth { get; set; }
    [Index(14)] public required string FinishedSide { get; set; }
