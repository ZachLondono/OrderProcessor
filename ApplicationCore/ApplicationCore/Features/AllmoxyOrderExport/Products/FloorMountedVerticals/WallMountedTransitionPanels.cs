...
public class WallMountedTransitionPanels : IAllmoxyProduct {

    [Index(0)] public required string Folder { get; set; }
    [Index(1)] public string Name => "Wall Mounted Transition Panels";
    ...
    [Index(11)] public required double TransitionDepth { get; set; }
