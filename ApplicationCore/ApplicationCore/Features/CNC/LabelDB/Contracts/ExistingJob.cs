...
public record ManufacturedPart(string Name, string Description, int PatternNumber, float Width, float Length, float InsertX, float InsertY, string ProductNumber, short HasFace6);