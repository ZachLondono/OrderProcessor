...
public class TransitionVerticalPanelComparer : IEqualityComparer<TransitionVerticalPanel> {
    public bool Equals(TransitionVerticalPanel? x, TransitionVerticalPanel? y) {
        ...
        if (x!.Room != y!.Room
            ...
            || x.Height != y.Height
            || x.Depth != y.Depth
            || x.TransitionDepth != y.TransitionDepth
    ...
    public int GetHashCode([DisallowNull] TransitionVerticalPanel obj) {
