...
public static partial class ProductsPersistance {
    ...
    private static void InsertProduct(object unknown, Guid orderId, ISynchronousDbConnection connection, ISynchronousDbTransaction trx)
        => throw new InvalidOperationException($"Attempting to insert unknown product type into databse {unknown.GetType()}");
