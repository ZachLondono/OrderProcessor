...
public class PieCutBaseCabinetDataModel : CabinetDataModelBase, IProductDataModel, IQueryableProductDataModel {
    ...
    public IProduct MapToProduct() {
        ...
        return new BasePieCutCornerCabinet(Id, Qty, UnitPrice, ProductNumber, Room, Assembled, Height, Width, Depth, boxMaterial, finishMaterial, doorConfiguration, EdgeBandColor, RightSideType, LeftSideType, Comment,
    ...
    public static string GetQueryByOrderId
        => """
            SELECT 
                ...
                pie_cut_base_cabinets.toe_type AS ToeType,
           	    pie_cut_base_cabinets.right_width AS RightWidth,
                pie_cut_base_cabinets.right_depth AS RightDepth,
            ...
            FROM pie_cut_base_cabinets

               JOIN products ON pie_cut_base_cabinets.product_id = products.id
               JOIN cabinets ON cabinets.product_id = pie_cut_base_cabinets.product_id
