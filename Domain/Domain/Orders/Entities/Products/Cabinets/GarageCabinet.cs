...
public abstract class GarageCabinet : Cabinet {
    ...
    protected GarageCabinet(Guid id,
							int qty,
							decimal unitPrice,
							int productNumber,
							string room,
							...
							Dimension width,
							Dimension depth,
							CabinetMaterial boxMaterial,
							CabinetFinishMaterial finishMaterial,
							CabinetDoorConfiguration doorConfiguration,
							string edgeBandingColor,
							CabinetSideType rightSideType,
							CabinetSideType leftSideType,
							string comment)
