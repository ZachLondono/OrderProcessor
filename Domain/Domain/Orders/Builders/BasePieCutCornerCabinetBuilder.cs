...
public class BasePieCutCornerCabinetBuilder : CabinetBuilder<BasePieCutCornerCabinet> {
    ...
    public override BasePieCutCornerCabinet Build() {
        var cabinet = BasePieCutCornerCabinet.Create(Qty, UnitPrice, ProductNumber, Room, Assembled, Height, Width, Depth, BoxMaterial, FinishMaterial, DoorConfiguration, EdgeBandingColor, RightSideType, LeftSideType, Comment, RightWidth, RightDepth, ToeType, AdjustableShelves, HingeSide);
