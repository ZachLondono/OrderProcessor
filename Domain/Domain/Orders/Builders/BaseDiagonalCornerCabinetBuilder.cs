...
public class BaseDiagonalCornerCabinetBuilder : CabinetBuilder<BaseDiagonalCornerCabinet> {
    ...
    public override BaseDiagonalCornerCabinet Build() {
        var cabinet = BaseDiagonalCornerCabinet.Create(Qty, UnitPrice, ProductNumber, Room, Assembled, Height, Width, Depth, BoxMaterial, FinishMaterial, DoorConfiguration, EdgeBandingColor, RightSideType, LeftSideType, Comment, RightWidth, RightDepth, ToeType, AdjustableShelves, HingeSide, DoorQty);
