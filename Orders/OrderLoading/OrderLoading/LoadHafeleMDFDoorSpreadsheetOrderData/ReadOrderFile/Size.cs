    ...
    public static Size[] LoadFromWorkbook(XLWorkbook workbook) {
        ...
        while (true) {
            ...
            sizes.Add(new Size {
                ...
                LeftStile = sheet.Cell("Left_Stile_Col").CellBelow(i).GetValueOrDefault<double>(0),
                RightStile = sheet.Cell("Right_Stile_Col").CellBelow(i).GetValueOrDefault<double>(0),
                TopRail = sheet.Cell("Top_Rail_Col").CellBelow(i).GetValueOrDefault<double>(0),
                BottomRail = sheet.Cell("Bottom_Rail_Col").CellBelow(i).GetValueOrDefault<double>(0),
